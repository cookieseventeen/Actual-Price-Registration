...
function SearchView({ onSearch, district, setDistrict, query, setQuery, filters, toggleFilter }) {
  const buildingTypes = window.BUILDING_TYPES;
  const layouts = ['2房2廳', '3房2廳', '4房2廳'];
  const trades = window.TRADE_TYPES;
  ...
  return (
    <div className="content-narrow fade-up">
      ...
      {/* 市場概況 */}
      <div style={{ display: 'flex', gap: 14, marginTop: 'var(--pad-6)' }}>
