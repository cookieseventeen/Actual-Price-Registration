...
const BUILDING_TYPES = ['住宅大樓', '華廈', '電梯華廈', '公寓', '透天厝', '套房'];
const LAYOUTS = ['1房1廳', '2房2廳', '3房2廳', '4房2廳', '套房'];
const TRADE_TYPES = ['成屋', '預售屋'];
...
Object.assign(window, {
  TC_DISTRICTS, BUILDING_TYPES, LAYOUTS, TRADE_TYPES, TRANSACTIONS,
  COMMUNITY_TREND, CITY_TREND, PRICE_DISTRIBUTION, CRAWL_TASKS,
});
